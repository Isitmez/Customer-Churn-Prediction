...
│   ├── benchmark.png                  # Model benchmarking results
│   ├── confusion_matrix.png           # Confusion Matrix visualization
│   ├── correlation_matrix.png         # Feature correlation heatmap
│   ├── feature_importance.png         # Bar chart showing most important features
│   ├── model_comparison.png           # Accuracy comparison between different models
│   ├── pr_curve.png                   # Precision-Recall curve
│   ├── roc_curve.png                  # ROC (Receiver Operating Characteristic) curve
│   └── shap_summary.png               # SHAP summary plot for model explainability
...
├── reports/
│   └── CustomerChurnPrediction.pdf    # Final project report
